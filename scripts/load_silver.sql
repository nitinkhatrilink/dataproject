...
RAISE NOTICE 'prd_info loaded in % sec',
EXTRACT(EPOCH FROM (end_time-start_time));
...
RAISE NOTICE 'sales_detail loaded in % sec',
EXTRACT(EPOCH FROM (end_time-start_time));
...
TRUNCATE TABLE silver.erp_loc_a1;

INSERT INTO silver.erp_loc_a1 (
cid,
cntry
)
...
RAISE NOTICE 'erp_loc_a1 loaded in % sec',
EXTRACT(EPOCH FROM (end_time-start_time));
...
TRUNCATE TABLE silver.cat_g1;

INSERT INTO silver.cat_g1 (
id,
cat,
subcat,
maintenance
...
RAISE NOTICE 'cat_g1 loaded in % sec',
EXTRACT(EPOCH FROM (end_time-start_time));

batch_end_time := CURRENT_TIMESTAMP;

RAISE NOTICE 'Silver Load Completed in % sec',
